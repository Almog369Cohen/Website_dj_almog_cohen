      ...
      <section className="px-4 py-24">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-3xl font-black text-white md:text-5xl">
            מוכנים לשדרג את החתונה?
          </h2>
          <p className="mb-8 text-lg text-white/85">
            בואו נבדוק זמינות ונדבר על החזון המוזיקלי שלכם.
          </p>
          <a
            href={wa("היי אלמוג, רוצים לשמוע על DJ לחתונה")}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 rounded-full bg-gradient-to-r from-[#059cc0] to-[#03b28c] px-10 py-5 text-xl font-bold text-white shadow-lg transition hover:scale-105"
          >
