...
export default function Home2026V5Variant1() {
  return (
          ...
          >
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between py-6 md:py-8 border-b border-white/10 hover:border-[#03b28c]/50 transition-all cursor-pointer">
                <div className="flex-1 mb-4 md:mb-0">
                  <div className="flex items-center gap-4 mb-3">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-[#059cc0]/20 to-[#03b28c]/20 backdrop-blur-xl border border-[#03b28c]/30 flex items-center justify-center flex-shrink-0">
            ...
            <div className="group">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between py-6 md:py-8 border-b border-white/10 hover:border-[#059cc0]/50 transition-all cursor-pointer">
                <div className="flex-1 mb-4 md:mb-0">
                  <div className="flex items-center gap-4 mb-3">
                    <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-[#059cc0]/20 to-[#03b28c]/20 backdrop-blur-xl border border-[#059cc0]/30 flex items-center justify-center flex-shrink-0">
