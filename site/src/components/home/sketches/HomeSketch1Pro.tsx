...
export default function HomeSketch1Pro() {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-6 py-3 mb-6">
                ...
                <span className="text-sm md:text-base font-bold">10+ שנות ניסיון | דירוג 5★</span>
              </div>
              ...
              <p className="text-xl sm:text-2xl md:text-3xl text-white/90 mb-8 leading-relaxed">
