...
const HomeSketch2Storyteller = dynamic(() => import("@/components/home/sketches/HomeSketch2Storyteller"), { ssr: false });

export default function PreviewSketch2Page() {
  useEffect(() => {
