...
const HomeSketch1Closer = dynamic(() => import("@/components/home/sketches/HomeSketch1Closer"), { ssr: false });

export default function PreviewSketch1Page() {
  useEffect(() => {
