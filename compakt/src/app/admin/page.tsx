...
import { Lock, Music, HelpCircle, Sparkles, LogOut, ChevronLeft, BarChart3, Eye, EyeOff, Loader2 } from "lucide-react";
      ...
      <div className="min-h-dvh gradient-hero flex items-center justify-center px-4">
        ...
        >
          ...
          <button
            ...
            className="mt-3 text-sm text-secondary hover:text-foreground transition-colors"
