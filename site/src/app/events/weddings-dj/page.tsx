...
export default function WeddingsDJPage() {
    ...
    <div className="min-h-screen bg-background">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Service",
            name: "DJ לחתונות",
            description: "שירות DJ מקצועי לחתונות - מהחופה ועד הרקדון האחרון",
      ...
      <div className="border-b border-border bg-background/50 px-4 py-3">
        <div className="mx-auto max-w-6xl">
          <nav className="flex items-center gap-2 text-sm text-foreground-secondary">
            ...
            <span>›</span>
            <span className="text-foreground-heading">DJ חתונות</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid gap-12 md:grid-cols-2 md:items-center">
            <div>
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-4">
                <div className="inline-flex items-center gap-2 rounded-full bg-brand-blue/20 px-4 py-1">
                  <div className="h-1.5 w-1.5 rounded-full bg-brand-blue" />
                  <span className="text-sm font-bold text-brand-blue">DJ לחתונות</span>
                </div>
              </motion.div>
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="mb-8 text-lg text-foreground-secondary">
                <strong className="text-foreground-heading">12 שנות ניסיון</strong> בחתונות יוקרה בכל רחבי הארץ. 
                מליווי מוזיקלי מהחופה, דרך הכניסה המרגשת, ועד הרקדון האחרון – 
                כל רגע מקבל את הפסקול המושלם שלו.
              </motion.p>

              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mb-8 space-y-3">
                {[
                  "התאמה מלאה לסגנון המוזיקלי שלכם",
                  "קריאת קהל מקצועית - כל הגילאים ברחבה",
                  "ציוד Pioneer מקצועי + סאונד איכותי",
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
                <a href={wa("היי אלמוג, מעוניינים ב-DJ לחתונה")} target="_blank" rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-brand-blue to-brand-green px-8 py-4 text-lg font-bold text-white transition hover:scale-105">
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 0.4 }}
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/30 to-brand-green/30" />
              <div className="relative flex h-full items-center justify-center">
                <div className="h-32 w-32 rounded-full bg-gradient-to-br from-brand-blue to-brand-green blur-3xl opacity-40" />
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="px-4 py-16">
        <div className="mx-auto max-w-4xl">
          <h2 className="mb-12 text-center text-3xl font-black text-foreground-heading md:text-5xl">השירות כולל</h2>
          <div className="grid gap-6 md:grid-cols-2">
            {[
              { title: "פגישת תכנון", desc: "נפגשים, מכירים ובונים את playlist המושלם" },
              { title: "ליווי מלא", desc: "מהחופה ועד הסיום - אני איתכם כל הדרך" },
              { title: "קריאת קהל", desc: "יודע מתי להרים, מתי להוריד ומתי לשנות כיוון" },
              { title: "ציוד מקצועי", desc: "Pioneer CDJ + מיקסר + סאונד איכותי" },
            ].map((item, i) => (
      ...
      <section className="px-4 py-24">
        <div className="mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-3xl font-black text-foreground-heading md:text-5xl">מוכנים להתחיל לתכנן?</h2>
          <p className="mb-8 text-lg text-foreground-secondary">בואו נבדוק זמינות ונדבר על החזון המוזיקלי של החתונה.</p>
          <a href={wa("היי אלמוג, רוצים לשמוע על DJ לחתונה")} target="_blank" rel="noopener noreferrer"
