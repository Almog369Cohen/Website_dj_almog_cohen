      ...
      <main className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-4 py-10 md:py-16">
        <nav className="text-sm text-foreground-secondary" aria-label="breadcrumb">
          <ol className="flex flex-wrap gap-1">
            ...
            <li className="text-foreground-heading">DJ או להקה?</li>
          </ol>
        </nav>
        ...
        <header className="space-y-3">
          ...
          <div className="flex flex-wrap items-center gap-3 text-xs text-foreground-secondary">
            <span className="rounded-full border border-border px-3 py-1">קטגוריה: החלטות מוזיקליות</span>
            <span className="rounded-full border border-border px-3 py-1">זמן קריאה: ~10 דקות</span>
          </div>
        </header>
