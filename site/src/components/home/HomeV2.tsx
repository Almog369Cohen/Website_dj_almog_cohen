          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-row gap-2 mb-4">
                ...
                >
                  <div className="relative flex items-center justify-center gap-1.5 px-4 py-2.5 bg-gradient-to-r from-[#059cc0] to-[#03b28c] text-white rounded-full font-black text-xs hover:scale-105 transition-transform whitespace-nowrap shadow-[0_0_20px_rgba(5,156,192,0.4)]">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="group relative"
            >
              <div className="relative flex items-center justify-center gap-3 px-12 py-6 bg-gradient-to-r from-[#059cc0] to-[#03b28c] text-white rounded-full font-black text-xl hover:scale-105 transition-transform shadow-[0_0_25px_rgba(5,156,192,0.4)]">
