  ...
  return (
    <div className="bg-brand-dark text-brand-white">
      <section className="mx-auto w-full max-w-6xl px-4 py-16">
        ...
        <p className="mb-10 text-foreground-secondary">ציוד דיג&#39;יי מקצועי – קונטרולרים, רמקולים, תאורה, אוזניות.</p>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            <h2 className="mb-2 text-xl font-semibold">קונטרולרים</h2>
            <p className="mb-4 text-foreground-secondary">הגדירו את הצרכים ואכוון לציוד מתאים.</p>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mb-4 text-foreground-secondary">PA לאירועים קטנים עד גדולים.</p>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <p className="mb-4 text-foreground-secondary">ליצירת אווירה וקונטרול מדויק.</p>
        ...
        <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="mb-4 text-foreground-secondary">איך לבנות סטאפ דיג&#39;יי מדויק (PDF)</p>
