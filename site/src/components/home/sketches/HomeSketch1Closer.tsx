...
export default function HomeSketch1Closer() {
  ...
  return (
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <motion.div 
        initial={{ y: -100 }}
        animate={{ y: 0 }}
        className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-red-600 to-orange-600 text-white py-3 px-4 text-center font-bold text-sm md:text-base"
      >
        🔥 נשארו רק {availableSlots} תאריכים זמינים לחודש הקרוב | {viewersCount} אנשים צופים עכשיו
      </motion.div>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
          ...
          >
            <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-6 py-3 mb-6">
              ...
              <span className="text-sm md:text-base font-bold">300+ חתונות מוצלחות | 10+ שנות ניסיון</span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              ...
              <div className="relative flex items-center justify-center gap-3 px-10 py-6 bg-white text-black rounded-full font-black text-lg md:text-xl hover:scale-105 transition-transform">
                ...
                <span>שלחו הודעה עכשיו - תגובה תוך 5 דקות</span>
              </div>
            </a>
          </motion.div>
      ...
      {/* Infinite Logo Carousel - Trust Building */}
      ...
      {/* Social Proof - Numbers That Convert */}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black mb-4">
              המספרים מדברים בשבילי
            </h2>
            <p className="text-white/60 text-lg md:text-xl">אין מקום לספקות. רק עובדות.</p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              ...
              {
                q: "איזה ציוד אתה משתמש?",
                a: "Pioneer CDJ-3000, Allen & Heath Mixer, ומערכת קול מקצועית. רק ציוד ברמה הגבוהה ביותר.",
                icon: <svg className="w-6 h-6 text-[#03b28c]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" /></svg>
              },
              {
                q: "מה קורה אם משהו לא עובד?",
                a: "יש לי ציוד גיבוי מלא לכל מקרה. בעשר שנות ניסיון, אף אירוע לא בוטל ואף תקלה טכנית לא עצרה את המוזיקה.",
      ...
      <section className="relative py-32 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="mb-12"
          >
            <div className="inline-flex items-center gap-2 bg-red-600/20 border border-red-600/50 rounded-full px-6 py-3 mb-8">
              <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse" />
              <span className="text-red-400 font-bold">⚠️ התאריכים נגמרים מהר</span>
            </div>
