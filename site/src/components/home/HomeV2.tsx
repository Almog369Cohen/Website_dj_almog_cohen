            ...
            >
              ...
              <div className="flex flex-row gap-2 mb-4">
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center gap-1.5 px-4 py-2.5 bg-white text-black rounded-full font-black text-xs hover:scale-105 transition-transform whitespace-nowrap">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="group relative"
            >
              <div className="absolute -inset-1 bg-gradient-to-r from-[#059cc0] to-[#03b28c] rounded-full blur-xl opacity-0 dark:opacity-75 group-hover:dark:opacity-100 transition animate-pulse" />
              <div className="relative flex items-center justify-center gap-3 px-12 py-6 bg-gradient-to-r from-[#059cc0] to-[#03b28c] text-white rounded-full font-black text-xl hover:scale-105 transition-transform shadow-lg">
