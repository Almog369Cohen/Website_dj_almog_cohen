    ...
    <section id="weddings-level-100" className="relative overflow-hidden bg-[#1f1f21] py-20 md:py-32">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6">
        ...
        <motion.div
          ...
          className="relative mt-16 overflow-hidden rounded-3xl border border-[#059cc0]/30 bg-gradient-to-br from-[#059cc0]/10 to-[#03b28c]/10 p-10 text-center backdrop-blur-md md:p-16"
        >
          <div className="brand-noise absolute inset-0 opacity-20" aria-hidden="true" />
          
          <div className="relative z-10">
            <h3 className="mb-6 text-3xl font-black text-white md:text-5xl" style={{ fontWeight: 900, letterSpacing: "-0.02em" }}>
              תפסיקו לגלול. <span className="text-[#03b28c]">מצאתם.</span>
            </h3>
            ...
            <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-white/80 md:text-xl">
              ...
              <br />
              <br />
              <strong className="text-white">בואו נכיר, נתאם ציפיות, ונבנה לכם ראש שקט ומסיבה מנצחת.</strong>
            </p>
