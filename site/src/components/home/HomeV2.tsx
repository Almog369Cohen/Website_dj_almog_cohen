  ...
  return (
    <div ref={pageRef} className="min-h-screen bg-black text-white relative overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 w-full text-center">
            ...
            >
              ...
              <div className="flex flex-row gap-3 mb-6 justify-center">
                ...
                >
                  <div className="relative flex items-center justify-center gap-1.5 px-4 py-2.5 bg-gradient-to-r from-[#059cc0] to-[#03b28c] text-white rounded-full font-black text-xs hover:scale-105 transition-transform whitespace-nowrap">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-1.5 px-4 py-2.5 border-2 border-white/20 rounded-full font-bold text-xs hover:bg-white/5 transition-all whitespace-nowrap"
                >
                  <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section className="relative py-10 md:py-14 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="reveal text-center mb-8">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mb-4 text-white">מה אומרים עליי</h2>
            <div className="h-1 w-24 mx-auto mb-4 bg-gradient-to-r from-[#059cc0] to-[#03b28c] rounded-full" />
            <p className="text-white text-base md:text-lg">הודעות אמיתיות מלקוחות אמיתיים</p>
          </div>
          <div className="flex justify-center">
            <div className="relative w-[260px] md:w-[280px] aspect-[9/19] rounded-[2rem] overflow-hidden border-2 border-white/10 shadow-2xl">
              <Image
                src="/assets/testimonials/wa-7.png"
                alt="ביקורת משי בר מצויה"
                fill
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="reveal flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="group relative"
            >
              <div className="relative flex items-center justify-center gap-3 px-12 py-6 bg-gradient-to-r from-[#059cc0] to-[#03b28c] text-white rounded-full font-black text-xl hover:scale-105 transition-transform">
