...
const weddingFAQs: FAQItem[] = [
  {
    ...
    answer: "מומלץ 4-6 חודשים מראש. תאריכים פופולריים (קיץ, חגים) נתפסים מהר. ככל שתסגרו מוקדם יותר, כך יש יותר זמן לתכנון מוזיקלי מדויק."
  },
  {
...
const academyFAQs: FAQItem[] = [
  {
    ...
    answer: "בכלל לא. היה לי תלמיד שהגיע עם אפס ניסיון על פלטה, ובשיעור השלישי כבר סגר אירוע ב-1,000 ₪. המסלולים בנויים מאפס מוחלט."
  },
  {
    question: "מה הציוד הנדרש?",
    answer: "כלום. בשיעורים אתם עובדים על XDJ-RX3, DDJ-1000, מחשבי Apple, מיקסר ורמקולים – הכל מסופק. לתרגול בבית מספיק תוכנת DJ חינמית ואוזניות."
  },
  {
    question: "כמה זמן עד שאוכל לנגן באירועים?",
    answer: "תלוי בך. יש תלמידים שכבר אחרי 3 שיעורים מתחילים לקבל הזדמנויות. במסלול PRO, אתה יוצא לאירועים אמיתיים כחלק מהתכנית."
  },
  {
    question: "מה ההבדל בין החבילות?",
    answer: "חבילת בסיס (1,500 ₪) – 3 מפגשים, היכרות עם תקלוט. התמחות שטח (3,800 ₪) – 6 מפגשים + יציאה לאירוע. מסלול PRO (7,000 ₪) – 8 מפגשים + שטח + ליווי + זומים עסקיים."
  },
  {
    question: "יש ליווי אחרי הלימודים?",
    answer: "במסלול PRO יש ליווי מלא כולל זומים עסקיים-מנטליים, יציאות לשטח, וליווי באירוע הראשון שלך. אפשר גם להוסיף ליוויים נוספים."
  },
];
